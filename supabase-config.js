...
// Admin accounts — these emails see the Admin dashboard (admin.html) and can read
// aggregate usage/feedback. Must match the corresponding RLS policy in the database.
window.ADMIN_EMAILS = ["ibrahimosman123cc@gmail.com"];
